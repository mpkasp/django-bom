...
bom_patterns = [
    ...
    path('part/<int:part_id>/part-change/<int:part_change_history_id>/', views.part_info, name='part-info-history'),
    path('part/<int:part_id>/part-change/<int:part_change_history_id>/remove-all-subparts/', views.remove_all_subparts, name='part-remove-all-subparts'),
