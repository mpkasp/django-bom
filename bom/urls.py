...
bom_patterns = [
    ...
    path('part-class/create-starter/', views.part_class_create_starter, name='part-class-create-starter'),
    ...
    path('upload-parts-template/', views.upload_parts_template, name='upload-parts-template'),
