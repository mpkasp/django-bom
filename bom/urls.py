...
bom_patterns = [
    ...
    path('part/<int:part_id>/<int:part_change_history_id>/', views.part_info, name='part-info-history'),
    ...
    path('part/<int:part_id>/<int:part_change_history_id>/edit-subpart/<int:subpart_id>', views.edit_subpart, name='part-edit-subpart'),
    path('part/<int:part_id>/<int:part_change_history_id>/remove-subpart/<int:subpart_id>/', views.remove_subpart, name='part-remove-subpart'),
    path('part/<int:part_id>/<int:part_change_history_id>/manage-bom/', views.manage_bom, name='part-manage-bom'),
    path('part/<int:part_id>/<int:part_change_history_id>/add-subpart/', views.add_subpart, name='part-add-subpart'),
